...
#. THI-Version: if the PS4 controller has not been connected to the Jetson, hold PS and SHARE button on controller while searching for Bluetooth devices with Jetson -> connect to "Wireless Controller"
